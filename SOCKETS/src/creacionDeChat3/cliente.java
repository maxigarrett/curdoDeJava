...
/*para que en un futuro podamos cargar las ip en el JComboBox este lo primero que tiene que hacer es 
 en cuanto se abre envie una señal al servidor para que este servidor tenga constancia de que tal 
 direccion ip a abierto la aplicacion y enviarle al resto de clientes que se encontraran por ahi 
 abiertos pues la direccion ip del que se acaba de conectarpara que de esta forma pueda ver que esta
 online y asi hablar entre si ¿y como conseguimos que al abrir la ventana envie esa señal al servidor?
 pues tendremos que crear un evento de ventana y bajo ese evento de ventana al abrir la ventana pues
 tendremos que enviar un paquete de datos al servidor para que el servidor reciba el paquete de datos
 y se de por enterado de que este cliente se encuentra online */
