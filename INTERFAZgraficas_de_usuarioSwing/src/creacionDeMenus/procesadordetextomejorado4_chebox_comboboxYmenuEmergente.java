...
public class procesadordetextomejorado4_chebox_comboboxYmenuEmergente
{
...
class laminaprocesador4 extends JPanel
{
	public laminaprocesador4() 
	{
		...
		/* configuraMenu2("12","tamaño","",9,12,"");
		 ...
		 JRadioButton doce=new JRadioButton("12",false);
		 JRadioButton dieciseis=new JRadioButton("16",false);
		 JRadioButton veinte=new JRadioButton("20",false);
		 JRadioButton veinticuatro=new JRadioButton("26",false);
