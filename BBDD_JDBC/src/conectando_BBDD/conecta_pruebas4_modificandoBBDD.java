...
public class conecta_pruebas4_modificandoBBDD
{
	...
	public static void main(String[] args)
	{
		...
		try 
		{
			...
			//con esta intruccion SQL eliminamos de la tabla productos solo el codigoarticulo que 
			//especificamos con WHERE sino establecemos este criterio borraria todo la BBDD
			//tambien podiamos poner NOMBREARTÍCULO='PANTALON' y elimina el mismo ya que pantalon
			//pertenece a el AR77
